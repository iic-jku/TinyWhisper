...
lint-verilog-all: ## Lint all Verilog source files (dsmod, cordic_iterative, lo_gen, riscv_top)
	$(MAKE) lint-verilog CELL=dsmod
	$(MAKE) lint-verilog CELL=cordic_iterative
	$(MAKE) lint-verilog CELL=lo_gen
	$(MAKE) lint-verilog

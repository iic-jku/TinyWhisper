...
N 1260 -1360 1260 -1340 {lab=Vcm}
N 1060 -1060 1080 -1060 {lab=VDD}
N 1060 -1080 1060 -1060 {lab=VDD}
...
op
remzerovec
write iqmod_mfb_lpf_ota_core_tb_Rout.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/scripts/plot_simulations/data/iqmod_mfb_lpf_ota_core_tb_Rout.txt v(Amag_dB) v(Aarg)
...
spice_ignore=true}
C {iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1060 -940 0 0 {name=x4
spice_ignore=false}
...
"}
C {single2dm.sym} 1060 -1340 0 0 {name=x6 gain=1}

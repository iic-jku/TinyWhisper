...
N 1320 -1140 1320 -1100 {lab=VDD}
N 1320 -1040 1320 -1000 {lab=GND}
...
N 1320 -680 1320 -660 {lab=Vcm}
N 1820 -900 1820 -880 {lab=VDD}
N 1820 -880 1860 -880 {lab=VDD}
N 1860 -880 1860 -860 {lab=VDD}
...
set wr_vecnames
set wr_singlescale
wrdata ../plot_simulations/data/iqmod_mfb_lpf_tb_Zin_dm.txt v(Zin_dm)
...
C {devices/vsource.sym} 1320 -1070 0 0 {name=VDD value=\{VDD\}}
C {devices/gnd.sym} 1320 -1000 0 0 {name=l3 lab=GND}
C {devices/capa.sym} 2180 -510 0 0 {name=C1
m=1
value=\{Cload\}
footprint=1206
device="ceramic capacitor"}
C {vdd.sym} 1320 -1140 0 0 {name=l7 lab=VDD}
...
spice_ignore=true}
C {iqmod_mfb_lpf.sym} 1840 -660 0 0 {name=x4
spice_ignore=false}
...
C {devices/code_shown.sym} 1920 -1530 0 0 {name=MODEL only_toplevel=true
...
"}
C {vdd.sym} 1820 -900 0 0 {name=l8 lab=VDD}
C {single2dm.sym} 1120 -660 0 0 {name=x6 gain=1}
C {devices/code_shown.sym} 60 -1510 0 0 {name=SAVE only_toplevel=true
format="tcleval( @value )"
value="

...
N 1140 -1120 1280 -1120 {lab=spdt_ctrl_n}
N 1280 -1120 1420 -1120 {lab=spdt_ctrl_n}
N 1560 -1120 1680 -1120 {lab=spdt_ctrl_buf}
N 1280 -980 1680 -980 {lab=spdt_ctrl_n}
N 1280 -1120 1280 -980 {lab=spdt_ctrl_n}
...
N 1460 -700 1480 -700 {lab=spdt_ctrl_n}
N 1460 -720 1460 -700 {
lab=spdt_ctrl_n}
N 1480 -700 1480 -640 {lab=spdt_ctrl_n}
N 1460 -500 1480 -500 {lab=spdt_ctrl_buf}
N 1080 -500 1100 -500 {lab=spdt_ctrl_n}
...
C {lab_pin.sym} 1680 -980 2 0 {name=p27 sig_type=std_logic lab=spdt_ctrl_n}
...
C {lab_pin.sym} 1100 -480 3 0 {name=p5 sig_type=std_logic lab=spdt_ctrl_n}
C {lab_pin.sym} 1460 -720 3 1 {name=p7 sig_type=std_logic lab=spdt_ctrl_n}
...
C {iqmod_spdt_switch_inv.sym} 1060 -1120 0 0 {name=x1}
C {iqmod_spdt_switch_inv.sym} 1480 -1120 0 0 {name=x2}
C {iqmod_spdt_switch_tg.sym} 1080 -600 0 0 {name=x3}
C {iqmod_spdt_switch_tg.sym} 1480 -600 0 1 {name=x4}
C {lab_pin.sym} 1080 -1180 3 1 {name=p53 sig_type=std_logic lab=nwell}

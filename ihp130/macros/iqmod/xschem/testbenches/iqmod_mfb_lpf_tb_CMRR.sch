...
op
remzerovec
write iqmod_mfb_lpf_tb_CMRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_mfb_lpf_tb_CMRR.txt v(Adm_dB) v(Adm_arg) v(Acm_dB) v(Acm_arg) v(CMRR_dB) v(CMRR_arg)

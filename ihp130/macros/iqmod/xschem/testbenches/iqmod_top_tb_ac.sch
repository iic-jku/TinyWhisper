...
only_toplevel=true 
value="
.include ../../verification/pex/iqmod_top_pex.spice
.param VDD=1.5
.param Vcm=VDD/2
.param temp=27
.param Cload=10p
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_top_tb_ac.txt v(Amag_dB) v(Aarg)
...
C {single2dm.sym} 360 -1500 0 0 {name=x7}

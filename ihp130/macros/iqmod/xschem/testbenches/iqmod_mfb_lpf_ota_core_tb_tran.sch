...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_mfb_lpf_ota_core_tb_tran.txt
...
C {single2dm.sym} 520 -640 0 0 {name=x7}
...
C {single2cm.sym} 520 -390 0 0 {name=x1
spice_ignore=true}

...
only_toplevel=true
value="
.include ../../verification/pex/iqmod_mixer_tg_pex.spice
.param VDD=1.5
.param Vcm=VDD/2
.param temp=27
.param Cload=10p
...
set wr_singlescale
set wr_vecnames
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_mixer_tg_tb_tran.txt v(vin_tg) v(vout_tg_on) v(vout_tg_off)

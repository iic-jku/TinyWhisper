...
only_toplevel=true 
value="
.include ../../verification/pex/iqmod_mfb_lpf_ota_core_inv_NF20_pex.spice
.param VDD=1.5
.param Vcm=VDD/2
.param temp=27
.param Cload=10p
...
op
remzerovec
write iqmod_mfb_lpf_ota_core_inv_tb_ac_ol.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_mfb_lpf_ota_core_inv_tb_ac_ol.txt v(Aol_dB) v(Aol_arg)

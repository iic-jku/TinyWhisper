...
op
remzerovec
write iqmod_mfb_lpf_ota_core_tb_noise.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/iqmod_mfb_lpf_ota_core_tb_noise.txt v(inoise_spectrum) v(onoise_spectrum)

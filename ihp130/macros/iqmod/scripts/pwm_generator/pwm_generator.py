...
def main():
  ...
  V_sig = 0.50 * VDD # Amplitude of sine/cosine signals (V)
  f_sig = 124.600e3 # Frequency of sine/cosine signals (Hz)
  ...
  # Write pwl data to .txt file (path relative to this script for universal usage)
  script_dir = os.path.dirname(os.path.abspath(__file__))
  data_dir = os.path.join(script_dir, 'data')
  os.makedirs(data_dir, exist_ok=True)
  pwm_sine_path = os.path.join(data_dir, 'pwm_sine_pwl.txt')
  with open(pwm_sine_path, 'w') as f:
  ...
  # Write pwl data to .txt file (reuse same data directory)
  pwm_cosine_path = os.path.join(data_dir, 'pwm_cosine_pwl.txt')
  with open(pwm_cosine_path, 'w') as f:

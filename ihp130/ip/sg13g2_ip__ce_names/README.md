...
A names IP block for [Julius-Maximilians-Universität Würzburg, Computer Engineering](https://www.informatik.uni-wuerzburg.de/ce/), rendered as a GDSII layout on a configurable metal layer (default `Metal5`) with `NoMetFiller` for the IHP SG13G2 130 nm CMOS process.
...
│  └─ 📁 vh/
│     └─ sg13g2_ip__ce_names.vh    # Verilog blackbox stub
└─ 📁 verification/
   └─ 📁 drc/                      # DRC reports
```

...
def tinywhisper_top_runner():
    ...
    if gl:
        ...
        sources.append(proj_path / f"../macros/riscv/final/nl/riscv_top.nl.v")
        ...
        # TinyWhisper
        sources.append(proj_path / "../macros/riscv/verilog/constants.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/riscv_top.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/alu.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/lo_gen.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/csr.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/memory.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/dsmod.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/regs.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/freq_generator.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/spi_master.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/control.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/i2c_master.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/i2c_master_mc.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/cordic_iterative.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/imm_gen.sv")
        sources.append(proj_path / "../macros/riscv/verilog/src/uart_tx.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/uart_rx.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/cordic_slice.v")
        sources.append(proj_path / "../macros/riscv/verilog/src/instructioncounter.sv")
    ...
    sources += [
        ...
        proj_path / "../ip/sg13g2_io_custom/verilog/sg13g2_io.v",
        # proj_path / "../ip/bondpad_70x70_novias/vh/bondpad_70x70_novias.v",

        # Custom IP TODO: Update with new IP
        # proj_path / "../ip/gf180mcu_ws_ip__id/vh/gf180mcu_ws_ip__id.v",
        # proj_path / "../ip/gf180mcu_ws_ip__logo/vh/gf180mcu_ws_ip__logo.v",
        proj_path / "../ip/sg13g2_ip__ce/vh/sg13g2_ip__ce.v",
        proj_path / "../ip/sg13g2_ip__jku/vh/sg13g2_ip__jku.v",
        proj_path / "../ip/sg13g2_ip__ce_names/vh/sg13g2_ip__ce_names.v",
        proj_path / "../ip/sg13g2_ip__jku_names/vh/sg13g2_ip__jku_names.v",
    ]

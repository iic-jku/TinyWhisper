...
N 1780 -1360 1820 -1360 {lab=vfp2}
N 1740 -1360 1780 -1360 {lab=vfp2}
N 1640 -1360 1680 -1360 {lab=vrp2}
N 1600 -1360 1640 -1360 {lab=vrp2}
N 1600 -1560 1600 -1360 {lab=vrp2}
...
N 1640 -1280 1680 -1280 {lab=vrn2}
N 1740 -1280 1780 -1280 {lab=vfn2}
N 1780 -1280 1820 -1280 {lab=vfn2}
N 1600 -1280 1640 -1280 {lab=vrn2}
N 1600 -1280 1600 -1080 {lab=vrn2}
...
N 1280 -1240 1360 -1240 {lab=#net6}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_tb_loopgain.raw
set appendwrite
* ===================================================
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_tb_loopgain.txt v(Tmb_dB) v(Tmb_arg) 
* ===================================================
...
C {devices/lab_pin.sym} 1920 -1440 2 0 {name=l34 sig_type=std_logic lab=filter_ota_en}
...
C {sky130_fd_pr/corner.sym} 1360 -1890 0 0 {name=CORNER only_toplevel=false corner=tt}
...
C {devices/lab_pin.sym} 1920 -700 2 0 {name=l5 sig_type=std_logic lab=filter_ota_en}
...
footprint=1206
device="ceramic capacitor"}
C {wspr_tx_iqmod_mfb_lpf_ota_core_gen.sym} 2840 -740 0 0 {name=x1 W_long=\{W_long\} W_short=\{W_short\} a=\{a\} L=\{L\} NF_long=\{NF_long\} NF_short=\{NF_short\}
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 2840 -440 0 0 {name=x2
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm_pex.sym} 2840 -140 0 0 {name=x3
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1900 -1320 0 0 {name=x4
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1900 -580 0 0 {name=x5
spice_ignore=false}

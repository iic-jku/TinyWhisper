...
N 1040 -1140 1040 -1120 {lab=ota_core_en}
N 820 -1020 820 -980 {lab=#net1}
N 820 -920 820 -860 {lab=GND}
N 1020 -700 1020 -660 {lab=ota_core_en}
N 1020 -600 1020 -560 {lab=GND}
N 1350 -650 1380 -650 {
lab=voutp}
N 1350 -610 1380 -610 {
lab=voutn}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_PSRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_PSRR.txt v(PSRR_dB)
...
C {devices/gnd.sym} 1020 -560 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 820 -950 0 0 {name=Vcm value=\{Vcm\}
}
C {devices/gnd.sym} 820 -860 0 0 {name=l40 lab=GND}
C {devices/vsource.sym} 1020 -630 0 0 {name=Ven value=\{VDD\}}
...
C {devices/lab_pin.sym} 1020 -700 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 1040 -1140 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
...
C {sky130_fd_pr/corner.sym} 1940 -1150 0 0 {name=CORNER only_toplevel=false corner=tt_mm}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1020 -1020 0 0 {name=x4
spice_ignore=false}

...
N 1060 -600 1060 -560 {lab=ota_core_en}
N 1060 -500 1060 -460 {lab=GND}
N 1500 -560 1500 -540 {
lab=vout}
N 1430 -530 1460 -530 {
lab=voutp}
...
N 1100 -1060 1100 -1040 {lab=ota_core_en}
N 1080 -1080 1080 -1040 {lab=VDD}
...
N 1120 -1220 1120 -1100 {lab=#net3}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_Rin.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_Rin.txt v(Amag_dB) v(Aarg)
...
C {devices/gnd.sym} 1060 -460 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 1280 -1290 0 0 {name=Vcm value=\{Vcm\}
}
C {devices/vsource.sym} 1060 -530 0 0 {name=Ven value=\{VDD\}}
...
C {devices/lab_pin.sym} 1100 -1060 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 1060 -600 2 0 {name=l17 sig_type=std_logic lab=ota_core_en}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1080 -940 0 0 {name=x4
spice_ignore=false}

...
N 560 -980 560 -960 {lab=GND}
N 520 -1200 520 -1180 {lab=VDD}
N 620 -1080 700 -1080 {lab=vout_RF}
N 560 -960 560 -940 {lab=GND}
...
N 1380 -880 1460 -880 {lab=vout_RF_filt}
N 1380 -880 1380 -820 {lab=vout_RF_filt}
N 1260 -880 1380 -880 {lab=vout_RF_filt}
...
only_toplevel=true
value="
*.include ../../spice/wspr_tx_iqmod_mixer_pex.spice
.param VDD=1.8
.param Vcm=VDD/2
.param temp=27
.param Cin=10p
...
op
remzerovec
write wspr_tx_iqmod_mixer_tb_tran.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mixer_tb_tran.txt v(vinp1_IF) v(vinn1_IF) v(vinp2_IF) v(vinn2_IF) v(LO_I) v(LO_IX) v(LO_Q) v(LO_QX) v(vout_RF) v(vout_RF_filt)
...
* set wr_vecnames
* set wr_singlescale
* wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mixer_tb_tran_fft.txt v(vout_RF_spec_db)
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mixer_tb_tran_fft_filt.txt v(vout_RF_filt_spec_db)
...
C {wspr_tx_iqmod_mixer.sym} 520 -1080 0 0 {name=x1}
...
C {devices/vsource.sym} 1040 -1440 0 1 {name=vsine spice_ignore=False value="sin(0 \{VDD/2\} \{fsig\})"
}
...
C {devices/vsource.sym} 400 -1440 0 1 {name=vcosine spice_ignore=False value="sin(0 \{VDD/2\} \{fsig\} 0 0 90)"
}
...
C {devices/lab_wire.sym} 1460 -880 0 1 {name=l37 sig_type=std_logic lab=vout_RF_filt}
C {devices/lab_wire.sym} 900 -920 0 1 {name=l21 sig_type=std_logic lab=vout_RF}
C {devices/gnd.sym} 1380 -700 0 0 {name=l2 lab=GND}
C {devices/capa.sym} 1380 -790 0 0 {name=C2
m=1
value=\{Cload\}
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 1080 -700 0 0 {name=l36 lab=GND}
C {res.sym} 1260 -790 0 0 {name=R2
value=\{Rload\}
footprint=1206
device=resistor
m=1}
...
C {lc_bp_filter.sym} 1080 -880 0 0 {name=x3}
C {wspr_tx_iqmod_mixer.sym} 520 -680 0 0 {name=x2}
...
C {single2dm.sym} 540 -1480 0 0 {name=x7}
...
C {single2dm.sym} 1180 -1480 0 0 {name=x4}

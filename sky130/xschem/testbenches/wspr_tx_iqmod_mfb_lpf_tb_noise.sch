...
N 780 -840 800 -840 {lab=vinp}
N 780 -760 800 -760 {lab=vinn}
...
N 980 -460 980 -420 {lab=filter_ota_en}
...
N 800 -840 820 -840 {lab=vinp}
N 800 -760 820 -760 {lab=vinn}
...
C {devices/code_shown.sym} 40 -1010 0 0 {name=NGSPICE
only_toplevel=true 
value="
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_tb_noise.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_tb_noise.txt v(inoise_spectrum) v(onoise_spectrum)
...
C {devices/lab_pin.sym} 980 -460 2 0 {name=l35 sig_type=std_logic lab=filter_ota_en}
C {devices/vsource.sym} 980 -390 0 0 {name=Ven value=\{VDD\}}
...
C {sky130_fd_pr/corner.sym} 1950 -1220 0 0 {name=CORNER only_toplevel=false corner=tt}

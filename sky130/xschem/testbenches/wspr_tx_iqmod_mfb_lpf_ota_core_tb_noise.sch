...
N 1020 -640 1020 -620 {lab=ota_core_en}
N 1000 -1040 1000 -1000 {lab=VDD}
N 1000 -940 1000 -900 {lab=GND}
N 1140 -1040 1140 -1000 {lab=ota_core_en}
N 1140 -940 1140 -900 {lab=GND}
N 1400 -760 1400 -740 {
lab=vout}
N 1330 -730 1360 -730 {
lab=voutp}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_noise.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_noise.txt v(inoise_spectrum) v(onoise_spectrum)
...
C {devices/gnd.sym} 1140 -900 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 700 -470 0 0 {name=Vcm value=\{Vcm\}
}
C {devices/vsource.sym} 1140 -970 0 0 {name=Ven value=\{VDD\}}
...
C {devices/lab_pin.sym} 1140 -1040 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 1020 -640 2 0 {name=l16 sig_type=std_logic lab=ota_core_en}
C {sky130_fd_pr/corner.sym} 1930 -1280 0 0 {name=CORNER only_toplevel=false corner=tt}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1000 -520 0 0 {name=x4
spice_ignore=false}
...
C {single2dm.sym} 500 -520 0 0 {name=x7}

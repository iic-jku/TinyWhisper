...
N 660 -1530 680 -1530 {lab=vin}
N 680 -1530 680 -1510 {lab=vin}
N 900 -1560 940 -1560 {lab=vinp}
N 900 -1480 940 -1480 {lab=vinn}
N 680 -1530 740 -1530 {lab=vin}
N 680 -1450 680 -1420 {lab=GND}
N 790 -1450 790 -1420 {lab=GND}
N 1020 -1520 1020 -1500 {lab=Vcm}
N 900 -1520 1020 -1520 {lab=Vcm}
N 1020 -1440 1020 -1420 {lab=GND}
N 1020 -1540 1020 -1520 {lab=Vcm}
C {devices/code_shown.sym} 40 -1250 0 0 {name=NGSPICE
only_toplevel=true 
value="
*.include ../../spice/wspr_tx_iqmod_pex.spice
.param VDD=1.8
.param Vcm=VDD/2
.param temp=27
.param Cload=10p
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_tb_ac.txt v(Amag_dB) v(Aarg)
...
C {wspr_tx_iqmod.sym} 1120 -780 0 0 {name=x1
spice_ignore=false}
...
C {wspr_tx_iqmod_pex.sym} 2980 -520 0 0 {name=x2
spice_ignore=true}
C {devices/vsource.sym} 1020 -1470 0 0 {name=Vcm value=\{Vcm\}
}
C {devices/vsource.sym} 680 -1480 0 0 {name=vin value="dc 0 ac 1"
}
C {lab_pin.sym} 660 -1530 2 1 {name=p5 sig_type=std_logic lab=vin}
C {devices/lab_pin.sym} 940 -1560 2 0 {name=l18 sig_type=std_logic lab=vinp}
C {devices/lab_pin.sym} 940 -1480 0 1 {name=l20 sig_type=std_logic lab=vinn
}
C {devices/gnd.sym} 680 -1420 0 0 {name=l22 lab=GND}
C {devices/gnd.sym} 790 -1420 0 0 {name=l25 lab=GND}
C {single2dm.sym} 820 -1520 0 0 {name=x7}
C {devices/lab_pin.sym} 1020 -1540 2 0 {name=l21 sig_type=std_logic lab=Vcm}
C {devices/gnd.sym} 1020 -1420 0 0 {name=l23 lab=GND}

...
C {wspr_tx_iqmod_mixer_lo_logic_gen.sym} 760 -1080 0 0 {name=x1 W_P=6.0 L_P=0.15 NF_P=2 W_N=2.0 L_N=0.15 NF_N=2 s=3}
C {wspr_tx_iqmod_mixer_lo_logic_gen.sym} 760 -560 0 0 {name=x3 W_P=6.0 L_P=0.15 NF_P=2 W_N=2.0 L_N=0.15 NF_N=2 s=3}
C {wspr_tx_iqmod_mixer_tg_gen.sym} 1560 -1080 0 0 {name=x2 W_P=57.0 L_P=0.15 NF_P=19 W_N=19.0 L_N=0.15 NF_N=19 W_P_D=12.0 L_P_D=0.15 NF_P_D=4 W_N_D=4.0 L_N_D=0.15 NF_N_D=4}
C {wspr_tx_iqmod_mixer_tg_gen.sym} 1560 -560 0 0 {name=x4 W_P=57.0 L_P=0.15 NF_P=19 W_N=19.0 L_N=0.15 NF_N=19 W_P_D=12.0 L_P_D=0.15 NF_P_D=4 W_N_D=4.0 L_N_D=0.15 NF_N_D=4}

...
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_NF4.sym} 2240 -720 0 0 {name=x1}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 580 -1100 0 0 {name=x2}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 580 -340 0 0 {name=x3}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF4.sym} 580 -720 0 0 {name=x4}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF4.sym} 1500 -720 0 1 {name=x5}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 920 -900 1 1 {name=x6}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 920 -540 1 0 {name=x7}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 1240 -720 0 1 {name=x8}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 260 -920 3 1 {name=x9}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 260 -520 3 0 {name=x10}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 1800 -520 3 0 {name=x11}
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_NF6.sym} 1800 -920 3 1 {name=x12}

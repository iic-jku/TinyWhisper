...
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF2.sym} 500 -880 0 0 {name=x1}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF2.sym} 760 -880 0 0 {name=x2}
C {wspr_tx_iqmod_mixer_lo_logic_tg.sym} 520 -500 0 0 {name=x3}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF2.sym} 760 -500 0 0 {name=x4}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF2.sym} 1580 -880 0 0 {name=x7}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF6.sym} 1880 -880 0 0 {name=x8}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF2.sym} 1580 -500 0 0 {name=x9}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF6.sym} 1880 -500 0 0 {name=x10}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF1.sym} 1120 -700 1 0 {name=x5}
C {wspr_tx_iqmod_mixer_lo_logic_inv_NF1.sym} 1360 -680 3 0 {name=x6}

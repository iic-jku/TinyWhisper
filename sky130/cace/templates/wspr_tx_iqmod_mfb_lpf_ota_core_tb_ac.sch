...
N 1480 -1960 1480 -1920 {lab=VDD}
N 1480 -1860 1480 -1820 {lab=GND}
N 1840 -1960 1840 -1920 {lab=ota_core_en}
...
N 1660 -1860 1660 -1820 {
lab=GND}
N 1660 -1960 1660 -1920 {
lab=VSS}
...
N 820 -460 820 -440 {lab=ota_core_en}
...
N 800 -460 800 -440 {lab=vdd_noise}
...
N 820 -1820 820 -1800 {lab=ota_core_en}
N 1020 -320 1020 -220 {lab=voutp3}
N 1120 -360 1120 -220 {lab=voutn3}
N 2020 -1960 2020 -1920 {lab=Vcm1}
N 2020 -1860 2020 -1820 {lab=GND}
N 2200 -1960 2200 -1920 {lab=Vcm2}
N 2200 -1860 2200 -1820 {lab=GND}
N 2380 -1960 2380 -1920 {lab=Vcm3}
N 2380 -1860 2380 -1820 {lab=GND}
N 800 -1600 800 -1480 {lab=GND}
...
N 820 -1140 820 -1120 {lab=ota_core_en}
N 800 -920 800 -800 {lab=GND}
N 900 -1040 1180 -1040 {lab=voutn2}
N 900 -1000 1080 -1000 {lab=voutp2}
N 800 -240 800 -120 {lab=GND}
...
C {devices/code_shown.sym} 1460 -1690 0 0 {name=NGSPICE
simulator=ngspice
only_toplevel=false
value="
...
.endc
"}
C {devices/vsource.sym} 1480 -1890 0 0 {name=VDD value=CACE\{vdd\}}
...
footprint=1206
device="ceramic capacitor"}
C {devices/vsource.sym} 1840 -1890 0 0 {name=V1 value=CACE\{vdd\}}
...
C {devices/vsource.sym} 1660 -1890 0 0 {name=VSS value=0 savecurrent=false}
C {devices/gnd.sym} 1660 -1820 0 0 {name=l16 lab=GND}
C {devices/lab_wire.sym} 1660 -1960 0 0 {name=p1 sig_type=std_logic lab=VSS}
C {devices/gnd.sym} 1480 -1820 0 0 {name=l2 lab=GND}
C {devices/gnd.sym} 1840 -1820 0 0 {name=l3 lab=GND}
...
C {vdd.sym} 1480 -1960 0 0 {name=l21 lab=VDD}
...
C {devices/lab_pin.sym} 800 -460 0 0 {name=l44 sig_type=std_logic lab=vdd_noise}
C {devices/gnd.sym} 800 -1480 0 0 {name=l5 lab=GND}
C {vdd.sym} 800 -1820 0 0 {name=l9 lab=VDD}
C {devices/vsource.sym} 2020 -1890 0 0 {name=Vcm1 value=CACE\{vcm\}
}
C {devices/lab_pin.sym} 2020 -1960 2 0 {name=l72 sig_type=std_logic lab=Vcm1}
C {devices/gnd.sym} 2020 -1820 0 0 {name=l73 lab=GND}
C {devices/vsource.sym} 2200 -1890 0 0 {name=Vcm2 value=CACE\{vcm\}
}
C {devices/lab_pin.sym} 2200 -1960 2 0 {name=l74 sig_type=std_logic lab=Vcm2}
C {devices/gnd.sym} 2200 -1820 0 0 {name=l75 lab=GND}
C {devices/vsource.sym} 2380 -1890 0 0 {name=Vcm3 value=CACE\{vcm\}
}
C {devices/lab_pin.sym} 2380 -1960 2 0 {name=l76 sig_type=std_logic lab=Vcm3}
C {devices/gnd.sym} 2380 -1820 0 0 {name=l77 lab=GND}
C {devices/lab_pin.sym} 820 -1820 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 820 -460 2 0 {name=l51 sig_type=std_logic lab=ota_core_en}
...
C {vdd.sym} 800 -1140 0 0 {name=l54 lab=VDD}
C {devices/lab_pin.sym} 820 -1140 2 0 {name=l55 sig_type=std_logic lab=ota_core_en}
C {devices/gnd.sym} 800 -120 0 0 {name=l30 lab=GND}
C {devices/lab_pin.sym} 1840 -1960 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 800 -1700 0 0 {name=x1
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 800 -1020 0 0 {name=x2
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 800 -340 0 0 {name=x3
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm_pex.sym} 1580 -380 0 0 {name=x4
spice_ignore=true}
C {generic/wspr_tx_iqmod_mfb_lpf_ota_core_gen.sym} 2120 -380 0 0 {name=x5 W_long=\{W_long\} W_short=\{W_short\} a=\{a\} L=\{L\} NF_long=\{NF_long\} NF_short=\{NF_short\}
spice_ignore=true}
...
C {../../xschem/single2dm.sym} 260 -1700 0 0 {name=x6}
C {../../xschem/single2cm.sym} 260 -1020 0 0 {name=x7}

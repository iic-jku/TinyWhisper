...
F {}
E {}
N 160 -200 160 -160 {lab=VSS}
N 200 -190 200 -160 {
lab=VSS}
N 400 -260 400 -220 {lab=Vcm}
N 400 -360 400 -320 {lab=vinp}
N 280 -310 360 -310 {lab=#net1}
N 200 -310 200 -250 {lab=#net1}
N 320 -130 360 -130 {lab=VSS}
N 200 -160 200 -130 {
lab=VSS}
N 320 -270 360 -270 {lab=VSS}
N 200 -130 320 -130 {lab=VSS}
N 200 -310 280 -310 {lab=#net1}
...
N 400 -360 480 -360 {lab=vinp}
N 400 -80 480 -80 {lab=vinn}
N 160 -130 200 -130 {lab=VSS}
N 160 -160 160 -130 {lab=VSS}
...
C {devices/opin.sym} 480 -80 0 0 {name=p7 lab=vinn}
C {devices/iopin.sym} 480 -220 0 0 {name=p2 lab=Vcm}
C {devices/opin.sym} 480 -360 0 0 {name=p1 lab=vinp}

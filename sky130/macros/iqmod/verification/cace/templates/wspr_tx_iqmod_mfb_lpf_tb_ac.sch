...
N 2280 -2120 2280 -2080 {lab=filter_ota_en}
N 2280 -2020 2280 -1980 {lab=GND}
...
N 1180 -700 1180 -680 {lab=filter_ota_en}
...
C {devices/code_shown.sym} 1900 -1850 0 0 {name=NGSPICE
simulator=ngspice
only_toplevel=false
value="
.lib CACE\{PDK_ROOT\}/CACE\{PDK\}/libs.tech/combined/sky130.lib.spice CACE\{corner\}
.include CACE\{DUT_path\}
*.include ../../spice/wspr_tx_iqmod_mfb_lpf.spice
.temp CACE\{temp\}
*.param W_long=18.0
*.param W_short=12.0
*.param a=3
...
footprint=1206
device="ceramic capacitor"}
C {devices/vsource.sym} 2280 -2050 0 0 {name=V1 value=CACE\{vdd\}}
...
C {devices/gnd.sym} 2280 -1980 0 0 {name=l3 lab=GND}
...
C {devices/lab_pin.sym} 1140 -700 0 0 {name=l44 sig_type=std_logic lab=vdd_noise}
C {devices/gnd.sym} 1160 -920 0 0 {name=l30 lab=GND}
C {vdd.sym} 1140 -1360 0 0 {name=l33 lab=VDD}
C {devices/gnd.sym} 1160 -1640 0 0 {name=l5 lab=GND}
C {vdd.sym} 1140 -2080 0 0 {name=l9 lab=VDD}
...
C {devices/lab_pin.sym} 1180 -2080 2 0 {name=l24 sig_type=std_logic lab=filter_ota_en}
C {devices/lab_pin.sym} 1180 -1360 2 0 {name=l37 sig_type=std_logic lab=filter_ota_en}
C {devices/lab_pin.sym} 1180 -700 2 0 {name=l51 sig_type=std_logic lab=filter_ota_en}
C {devices/lab_pin.sym} 2280 -2120 2 0 {name=l4 sig_type=std_logic lab=filter_ota_en}
...
C {wspr_tx_iqmod_mfb_lpf.sym} 1160 -1860 0 0 {name=x1
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf.sym} 1160 -1140 0 0 {name=x2
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf.sym} 1160 -480 0 0 {name=x3
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_pex.sym} 2140 -440 0 0 {name=x4
spice_ignore=true}
C {generic/wspr_tx_iqmod_mfb_lpf_gen.sym} 2940 -440 0 0 {name=x5
spice_ignore=true}
...
C {../../xschem/single2dm.sym} 540 -1860 0 0 {name=x6}
C {../../xschem/single2cm.sym} 540 -1140 0 0 {name=x7}

...
def postprocess(results: dict[str, list], conditions: dict[str, Any]) -> dict[str, list]:
    ...
    np.savetxt(f'cace/scripts/{csv_filename}',
               # np.column_stack((np.array(Adc_ol_dB_arr), np.array(fcu_arr), np.array(CMRR_dc_dB_arr), np.array(PSRR_dc_dB_arr))), comments = "", 
               # header = "Adc_ol_dB_arr,fcu_arr,CMRR_dc_dB_arr,PSRR_dc_dB_arr", delimiter = ",")
               np.column_stack((np.array(Adc_ol_dB_arr), np.array(fcu_arr), np.array(CMRR_dc_dB_arr))), comments = "", 
               header = "Adc_ol_dB_arr,fcu_arr,CMRR_dc_dB_arr", delimiter = ",")
    
    # return {'Adc_ol_dB_arr': Adc_ol_dB_arr, 'fcu_arr': fcu_arr, 'CMRR_dc_dB_arr': CMRR_dc_dB_arr, 'PSRR_dc_dB_arr': PSRR_dc_dB_arr}
    return {'Adc_ol_dB_arr': Adc_ol_dB_arr, 'fcu_arr': fcu_arr, 'CMRR_dc_dB_arr': CMRR_dc_dB_arr}
# ============================================
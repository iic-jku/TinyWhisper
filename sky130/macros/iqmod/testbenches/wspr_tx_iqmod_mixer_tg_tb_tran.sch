...
C {code_shown.sym} 40 -970 0 0 {name=NGSPICE
only_toplevel=true
value="
.param VDD=1.8
.param Vcm=VDD/2
...
op
remzerovec
write wspr_tx_iqmod_mixer_tg_tb_tran.raw
set appendwrite
...
set wr_singlescale
set wr_vecnames
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mixer_tg_tb_tran.txt v(vin_tg) v(vout_tg_on) v(vout_tg_off)
...
C {sky130_fd_pr/corner.sym} 1860 -1470 0 0 {name=CORNER only_toplevel=false corner=tt}
C {wspr_tx_iqmod_mixer_tg_gen.sym} 1140 -1120 0 0 {name=x1 W_P=57.0 L_P=0.15 NF_P=19 W_N=19.0 L_N=0.15 NF_N=19 W_P_D=12.0 L_P_D=0.15 NF_P_D=4 W_N_D=4.0 L_N_D=0.15 NF_N_D=4}
C {wspr_tx_iqmod_mixer_tg_gen.sym} 1140 -800 0 0 {name=x2 W_P=57.0 L_P=0.15 NF_P=19 W_N=19.0 L_N=0.15 NF_N=19 W_P_D=12.0 L_P_D=0.15 NF_P_D=4 W_N_D=4.0 L_N_D=0.15 NF_N_D=4}

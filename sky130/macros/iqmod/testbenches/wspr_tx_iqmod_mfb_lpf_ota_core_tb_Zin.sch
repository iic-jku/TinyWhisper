...
N 1160 -1140 1160 -1120 {lab=ota_core_en}
N 420 -1480 420 -1440 {lab=VDD}
N 420 -1380 420 -1340 {lab=GND}
N 560 -1480 560 -1440 {lab=ota_core_en}
N 560 -1380 560 -1340 {lab=GND}
...
N 1160 -700 1160 -680 {lab=ota_core_en}
N 1140 -720 1140 -680 {lab=VDD}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_Zin.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_Zin.txt v(Zin_dm) v(Zin_cm)
...
C {devices/vsource.sym} 420 -1410 0 0 {name=VDD value=\{VDD\}}
C {devices/gnd.sym} 420 -1340 0 0 {name=l3 lab=GND}
C {devices/capa.sym} 1380 -930 0 0 {name=C1
m=1
value=\{Cload\}
footprint=1206
device="ceramic capacitor"}
C {vdd.sym} 420 -1480 0 0 {name=l7 lab=VDD}
...
C {devices/gnd.sym} 560 -1340 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 560 -1410 0 0 {name=Ven value=\{VDD\}}
C {devices/lab_pin.sym} 560 -1480 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 1160 -1140 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
...
C {devices/lab_pin.sym} 1160 -700 2 0 {name=l33 sig_type=std_logic lab=ota_core_en}
...
C {sky130_fd_pr/corner.sym} 1960 -1350 0 0 {name=CORNER only_toplevel=false corner=tt}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1140 -1020 0 0 {name=x4
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1140 -580 0 0 {name=x5
spice_ignore=false}
...
C {single2dm.sym} 1140 -1440 0 0 {name=x7}

...
N 4390 -1920 4390 -1880 {lab=filter_ota_en}
N 4390 -1820 4390 -1780 {lab=GND}
...
N 2480 -2180 2540 -2180 {lab=vrp1}
N 2480 -2100 2540 -2100 {lab=vrn1}
...
lab=GND}
N 2180 -1360 2220 -1360 {lab=vfp2}
N 2140 -1360 2180 -1360 {lab=vfp2}
N 2040 -1360 2080 -1360 {lab=vrp2}
N 2000 -1360 2040 -1360 {lab=vrp2}
N 2000 -1560 2000 -1360 {lab=vrp2}
...
N 2040 -1280 2080 -1280 {lab=vrn2}
N 2140 -1280 2180 -1280 {lab=vfn2}
N 2180 -1280 2220 -1280 {lab=vfn2}
N 2000 -1280 2040 -1280 {lab=vrn2}
N 2000 -1280 2000 -1080 {lab=vrn2}
...
N 1680 -1240 1760 -1240 {lab=#net11}
...
N 2180 -2060 2260 -2060 {lab=#net25}
...
N 3320 -1240 3400 -1240 {lab=#net31}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_tb_loopgain_all.raw
set appendwrite
* ===================================================
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_tb_loopgain_all.txt v(L_dB) v(L_arg) v(Tmb_dB) v(Tmb_arg) v(Ttian_dB) v(Ttian_arg)
* ===================================================
...
C {devices/gnd.sym} 4390 -1780 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 4390 -1920 2 0 {name=l35 sig_type=std_logic lab=filter_ota_en}
...
C {devices/vsource.sym} 4390 -1850 0 0 {name=Ven value=\{VDD\}}
...
C {sky130_fd_pr/corner.sym} 3700 -2740 0 0 {name=CORNER only_toplevel=false corner=tt}
...
C {devices/lab_pin.sym} 2320 -1440 2 0 {name=l34 sig_type=std_logic lab=filter_ota_en}
...
C {devices/lab_pin.sym} 2320 -700 2 0 {name=l49 sig_type=std_logic lab=filter_ota_en}
...
C {devices/lab_pin.sym} 2820 -2260 2 0 {name=l52 sig_type=std_logic lab=filter_ota_en}
...
C {devices/lab_pin.sym} 3960 -1440 2 0 {name=l78 sig_type=std_logic lab=filter_ota_en}
...
C {devices/lab_pin.sym} 3960 -700 2 0 {name=l64 sig_type=std_logic lab=filter_ota_en}
...
footprint=1206
device="ceramic capacitor"}
C {wspr_tx_iqmod_mfb_lpf_ota_core_gen.sym} 4320 -2760 0 0 {name=x1 W_long=\{W_long\} W_short=\{W_short\} a=\{a\} L=\{L\} NF_long=\{NF_long\} NF_short=\{NF_short\}
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 4320 -2460 0 0 {name=x2
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm_pex.sym} 4320 -2160 0 0 {name=x3
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 2800 -2140 0 0 {name=x5
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 2300 -1320 0 0 {name=x4
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 2300 -580 0 0 {name=x6
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 3940 -1320 0 0 {name=x7
spice_ignore=false}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 3940 -580 0 0 {name=x8
spice_ignore=false}

...
N 1260 -380 1260 -340 {lab=GND}
N 1440 -480 1440 -440 {lab=ota_core_en}
...
N 1100 -1060 1100 -1020 {lab=ota_core_en}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_Vout.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_Vout.txt v(vinp) v(voutp) v(voutn)
...
C {devices/vsource.sym} 1260 -410 0 0 {name=VDD value=\{VDD\}}
C {devices/gnd.sym} 1260 -340 0 0 {name=l3 lab=GND}
C {vdd.sym} 1260 -480 0 0 {name=l7 lab=VDD}
C {devices/gnd.sym} 1440 -340 0 0 {name=l6 lab=GND}
C {devices/lab_pin.sym} 1440 -480 2 0 {name=l13 sig_type=std_logic lab=ota_core_en}
C {devices/vsource.sym} 1440 -410 0 0 {name=Ven value=\{VDD\}}
...
C {devices/lab_pin.sym} 1100 -1060 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {sky130_fd_pr/corner.sym} 1940 -1310 0 0 {name=CORNER only_toplevel=false corner=tt}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1080 -920 0 0 {name=x4
spice_ignore=false}
...
C {single2dm.sym} 1080 -1380 0 0 {name=x7}

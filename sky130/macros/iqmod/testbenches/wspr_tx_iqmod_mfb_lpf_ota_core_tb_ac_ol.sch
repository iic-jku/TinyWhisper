...
N 1040 -780 1040 -760 {lab=ota_core_en}
N 1020 -1400 1020 -1360 {lab=VDD}
N 1020 -1300 1020 -1260 {lab=GND}
N 1220 -1400 1220 -1360 {lab=ota_core_en}
N 1220 -1300 1220 -1260 {lab=GND}
N 1350 -870 1380 -870 {
lab=voutp}
N 1350 -830 1380 -830 {
lab=voutn}
N 1020 -800 1020 -760 {lab=VDD}
...
N 1220 -1080 1220 -1040 {lab=Vcm}
N 1100 -1060 1220 -1060 {lab=Vcm}
N 1220 -980 1220 -960 {lab=GND}
C {devices/code_shown.sym} 60 -1490 0 0 {name=NGSPICE
only_toplevel=true 
value="
.param VDD=1.8
.param Vcm=VDD/2
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_tb_ac_ol.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_ota_core_tb_ac_ol.txt v(Aol_dB) v(Aol_arg)
...
C {devices/vsource.sym} 1020 -1330 0 0 {name=VDD value=\{VDD\}}
C {devices/gnd.sym} 1020 -1260 0 0 {name=l3 lab=GND}
C {devices/capa.sym} 1320 -570 0 0 {name=C1
m=1
value=\{Cload\}
footprint=1206
device="ceramic capacitor"}
C {vdd.sym} 1020 -1400 0 0 {name=l7 lab=VDD}
...
C {devices/gnd.sym} 1220 -1260 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 1220 -1330 0 0 {name=Ven value=\{VDD\}}
...
C {devices/lab_pin.sym} 1220 -1400 2 0 {name=l4 sig_type=std_logic lab=ota_core_en}
C {devices/lab_pin.sym} 1040 -780 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
...
C {sky130_fd_pr/corner.sym} 1920 -1250 0 0 {name=CORNER only_toplevel=false corner=tt}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf_ota_core_hybrid_bm.sym} 1020 -660 0 0 {name=x4
spice_ignore=false}

...
N 1060 -720 1060 -680 {lab=filter_ota_en}
...
N 1080 -1380 1080 -1360 {lab=filter_ota_en}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_tb_PSRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_tb_PSRR.txt v(PSRR_dB)
...
C {devices/lab_pin.sym} 1060 -720 2 0 {name=l35 sig_type=std_logic lab=filter_ota_en}
C {devices/vsource.sym} 1060 -650 0 0 {name=Ven value=\{VDD\}}
C {devices/vdd.sym} 1040 -1380 0 0 {name=l4 lab=VDD}
C {devices/lab_pin.sym} 1080 -1380 2 0 {name=l8 sig_type=std_logic lab=filter_ota_en}
C {sky130_fd_pr/corner.sym} 1950 -1300 0 0 {name=CORNER only_toplevel=false corner=tt_mm}
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf.sym} 1060 -1160 0 0 {name=x4
spice_ignore=false}

...
N 980 -1360 980 -1320 {lab=VDD}
N 1020 -1340 1020 -1320 {lab=ota_core_en}
...
N 980 -620 980 -580 {lab=VDD}
N 1020 -600 1020 -580 {lab=ota_core_en}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_tb_CMRR.raw
set appendwrite
...
set wr_vecnames
set wr_singlescale
wrdata $PROJECT_PATH/python/plot_simulations/data/wspr_tx_iqmod_mfb_lpf_tb_CMRR.txt v(Adm_dB) v(Adm_arg) v(Acm_dB) v(Acm_arg) v(CMRR_dB) v(CMRR_arg)
...
spice_ignore=true}
C {wspr_tx_iqmod_mfb_lpf.sym} 1000 -1120 0 0 {name=x4
spice_ignore=false}
...
C {devices/lab_pin.sym} 1020 -1340 2 0 {name=l24 sig_type=std_logic lab=ota_core_en}
...
C {single2dm.sym} 340 -1120 0 0 {name=x7}
...
C {single2cm.sym} 340 -380 0 0 {name=x8}
...
C {wspr_tx_iqmod_mfb_lpf.sym} 1000 -380 0 0 {name=x5
spice_ignore=false}
C {vdd.sym} 980 -620 0 0 {name=l17 lab=VDD}
C {devices/lab_pin.sym} 1020 -600 2 0 {name=l18 sig_type=std_logic lab=ota_core_en}

...
T {di_en = 0... enable
di_en = 1... disable} 1140 -1090 0 0 0.25 0.25 {}
N 1420 -660 1420 -620 {
lab=GND}
N 940 -800 940 -740 {
lab=vin}
...
N 1200 -980 1200 -860 {lab=VDD}
N 1240 -900 1240 -860 {lab=VDD}
N 1200 -900 1240 -900 {lab=VDD}
...
op
remzerovec
write wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_tb_tran.raw
set appendwrite
...
C {vdd.sym} 1200 -980 0 0 {name=l6 lab=VDD}
...
C {wspr_tx_iqmod_mfb_lpf_ota_core_inv_lv_en_gen.sym} 1220 -800 0 0 {name=x1 W_P=3.0 L_P=0.35 NF_P=1 W_N=1.0 L_N=0.35 NF_N=1}
